...
Write-Host "Installing Visual Studio ${vsToolset.subversion} ${vsToolset.edition} ${vsToolset.channel}..."
...
Write-Host "Disabling auto-update of VSIX extensions..."
...
if (Test-IsWin19) {
    ...
    Write-Host "Installing Windows 10 SDK version 10.0.14393.795..."
    ...
    Write-Host "Installing Windows 11 SDK version 10.0.22621.0..."
    Install-Binary -Type EXE `
...
if (Test-IsWin22) {    
    ...
    Write-Host "Installing Windows 10 SDK version 10.0.17763..."
    Install-Binary -Type EXE `
...
Write-Host "Starting Visual Studio tests..."
