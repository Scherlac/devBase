...
$VersionsManifest = Invoke-RestMethodAuth "https://product-details.mozilla.org/1.0/firefox_versions.json"
...
$GeckoDriverJson = Invoke-RestMethodAuth "https://api.github.com/repos/mozilla/geckodriver/releases/latest"
